...
ggplot(transProb, aes(x = buzzNum, y = t11)) + 
  geom_line() + 
  geom_ribbon(aes(ymin = t11L, ymax = t11U), alpha = 0.2)


ggplot(transProb, aes(x = buzzNum, y = t12)) + 
  geom_line() + 
  geom_ribbon(aes(ymin = t12L, ymax = t12U), alpha = 0.2)

ggplot(transProb, aes(x = buzzNum, y = t21)) + 
  geom_line() + 
  geom_ribbon(aes(ymin = t21L, ymax = t21U), alpha = 0.2)


ggplot(transProb, aes(x = buzzNum, y = t13)) + 
  geom_line() + 
  geom_ribbon(aes(ymin = t13L, ymax = t13U), alpha = 0.2)

ggplot(transProb, aes(x = buzzNum, y = t23)) + 
  geom_line() + 
  geom_ribbon(aes(ymin = t23L, ymax = t23U), alpha = 0.2)


qplot(transProb$t11, x = transProb$buzzNum)
qplot(transProb$t12, x = transProb$buzzNum)
qplot(transProb$t13, x = transProb$buzzNum)


qplot(transProb$t11, x = transProb$buzzNum)
qplot(transProb$t22, x = transProb$buzzNum)

qplot(transProb$t21, x = transProb$buzzNum)
qplot(transProb$t12, x = transProb$buzzNum)
